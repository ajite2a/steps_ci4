        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= (strpos(current_url(), 'sync') !== false) ? 'active' : '' ?>" href="<?= route_to('sync.index') ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-repeat me-1" viewBox="0 0 16 16" aria-hidden="true">
                    ...
                    <li class="nav-item">
                        <a class="nav-link <?= (strpos(current_url(), 'settings') !== false) ? 'active' : '' ?>" href="<?= route_to('setting.index') ?>">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-gear me-1" viewBox="0 0 16 16" aria-hidden="true">
